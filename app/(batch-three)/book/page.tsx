...
export const metadata: Metadata = { title: "Appointment Booking Status — Sigma Core Richmond", description: "Sigma Core's scheduling calendar is not yet connected. Check the current booking status and explore Richmond-area care information.", robots: { index: false, follow: true } };
