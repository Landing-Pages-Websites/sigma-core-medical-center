...
export const metadata: Metadata = { title: "Educational Guide Status", description: "The Sigma Core educational resource is pending approval and is not available for download. Explore other Richmond-area care information while it is prepared.", robots: { index: false, follow: true } };
