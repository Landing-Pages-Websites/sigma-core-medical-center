...
export const metadata: Metadata = { title: "About Our Center in Richmond, VA", description: "Learn about Sigma Core Medical Center's purpose and care principles for the Richmond area. Team and location details await verification." };
